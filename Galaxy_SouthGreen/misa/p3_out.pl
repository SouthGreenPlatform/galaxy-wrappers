...
open (OUT,">$res_file") || die ("nError: Couldn't create file !\n\n");
...
# "\n\tPrimer modelling was successful for $count sequence(s).\n";
#print "\tPrimer modelling failed for $count_failed sequence(s).\n";
