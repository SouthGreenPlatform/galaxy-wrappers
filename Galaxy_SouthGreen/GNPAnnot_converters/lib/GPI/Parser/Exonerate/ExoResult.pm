package GPI::Parser::Exonerate::ExoResult;
...
$Id: ExoResult.pm,v 1.2 2007/03/01 09:28:04 equevill Exp $
$Log: ExoResult.pm,v $
Revision 1.2  2007/03/01 09:28:04  equevill
...
sub rawscore{
  my $self = shift;
  if(exists $self->{rawscore}) {
    return $self->{rawscore};
  }
  else {
    return $TAGS{rawscore};
  }
}
