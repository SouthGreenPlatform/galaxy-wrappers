...
my $PLINK_EXE = "/home/galaxydev/galaxy/tools/SouthGreen/snmf/plink";
my $SNMF_PATH = "/home/galaxydev/galaxy/tools/SouthGreen/snmf/sNMF_CL_v1.2/bin";

system("$PLINK_EXE --vcf $input --allow-extra-chr --recode-vcf --out $directory/input >>$directory/plink.log 2>&1");

system("$SNMF_PATH/vcf2geno $directory/input.vcf $directory/polymorphisms.geno >>$directory/vcf2geno.log 2>&1");
...
{
	system("$SNMF_PATH/sNMF -x $directory/polymorphisms.geno -K $k -c >>$directory/log.$k 2>&1");
